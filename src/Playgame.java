...
public class Playgame {
    ...
    public static Player findnextplayer(Player currentplayer, Player player1, Player player2) {
        ...
        if (currentplayer.getmoreturn = true)
    ...
    public void rolldicesandgetresult(Player currentplayer) {
        currentplayer = findnextplayer(Player currentplayer, Player player1, Player player2);
        ...
        switch (Result) {
            case 2:
                ...
                if (language.equals("en")) {
                    ...
                    System.out.println("Current money of " + currentplayer.getName() + " is " + currentplayer.getMoney());
                }
                if (language.equals("dk")) {
                    System.out.println("Tillykke du kom en tur i tårnet og tjente 250");
                    System.out.println(currentplayer.getName() + "s nuværende beløb er " + currentplayer.getMoney());
                }
                break;
            case 3:
